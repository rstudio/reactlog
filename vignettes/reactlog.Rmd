...
Hovering over a particular graph element (either a node or an edge) highlights that element's family tree. A single click will maintain that highlighting. Double-clicking elements filters the graph that element's family tree. To clear the highlighting and filter selections, click/double-click the background of the graph or press the `Esc` key when the graph is in focus.
